...
public class ReportScheduleConfig {
    ...
    public void createNewVisitorViewAndSave() {
        ...
        // 날짜 변경 후, 데이터 초기화
        visitorViewService.getView().set(0L);
        visitorViewService.getLoginView().set(0L);
        visitorViewService.getUserJoin().set(0L);
        visitorViewService.getWriteCreatedNumber().set(0L);
        visitorViewService.initDate();
    }
